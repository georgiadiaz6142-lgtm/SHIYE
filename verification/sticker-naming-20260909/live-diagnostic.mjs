...
const record={kind:'one diagnostic naming call to capture rejection code; no segmentation',source:'previously approved night-building-box-0.png',attemptedAt:new Date().toISOString()};
const path=new URL('./live-diagnostic.json',import.meta.url);
